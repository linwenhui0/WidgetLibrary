...
public class HCameraManager {
    ...
    private ICameraTakePhoto cameraTakePhoto;
    ...
    public HCameraManager(Activity activity) {
    ...
    public void setCameraTakePhoto(ICameraTakePhoto cameraTakePhoto) {
    ...
    private void setUpCameraOutputs(CameraManager manager, int width, int height) throws NullPointerException {
        if (manager == null)
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    if (viewAspectRatio != null) {
                        viewAspectRatio.onAspectRatio(mPreviewSize.getWidth(), mPreviewSize.getHeight());
                    }
                } else {
                    if (viewAspectRatio != null) {
                        viewAspectRatio.onAspectRatio(mPreviewSize.getHeight(), mPreviewSize.getWidth());
                    }
                }
    ...
    public void configureTransform(int viewWidth, int viewHeight) {
        if (null == viewAspectRatio || null == mPreviewSize || null == activity) {
            return;
        }
        ...
        if (viewAspectRatio != null)
            viewAspectRatio.onTransform(matrix);
    }
    ...
    private void createCameraPreviewSession() {
        try {
            SurfaceTexture texture = viewAspectRatio.getSurfaceTexture();
            assert texture != null;
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(
                            ...
                            if (viewAspectRatio != null)
                                viewAspectRatio.onMessageInfo("Failed");
                        }
                    }, null
            );
        } catch (CameraAccessException e) {
