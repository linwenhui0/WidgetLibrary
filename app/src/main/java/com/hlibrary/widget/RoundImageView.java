...
public class RoundImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            roundWidth = a.getDimensionPixelSize(R.styleable.RoundAngleImageView_round_width, roundWidth);
            roundHeight = a.getDimensionPixelSize(R.styleable.RoundAngleImageView_round_height, roundHeight);
            a.recycle();
        } else {
    ...
    public void draw(Canvas canvas) {
        ...
        roundWidth = roundWidth < (getWidth() / 2) ? roundWidth : (getWidth() / 2);
        roundHeight = roundHeight < (getHeight() / 2) ? roundHeight : (getHeight() / 2);
